  ...
  return (
    <>
      {inVoid ?
        ...
        : null}
      <h2 className={clsx("h-9  leading-none content-center whitespace-pre-line pointer-events-none", inVoid && "outline outline-1 outline-text px-2 -translate-x-2")}>{children}</h2>
    </>
