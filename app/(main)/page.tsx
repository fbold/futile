...
export default function Home() {
  return (
    <div className="w-full h-full flex items-start md:items-center justify-center overflow-scroll">
      <div className="mx-6 my-24 sm:mx-0 sm:w-1/2 2xl:w-1/5 text-center whitespace-pre-wrap">
        <div>
          ...
          <div className="mt-10 text-left whitespace-pre-wrap border p-5 text-text font-mono">
            ...
            <ul className={`ml-2 my-2 list-["+"] list-outside`}>
              ...
              <li className="pl-1.5">
                ...
                to. still not sure about surrounding functionaliy
              </li>
              <li className="pl-1.5">
